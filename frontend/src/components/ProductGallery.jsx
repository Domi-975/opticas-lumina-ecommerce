...
export default function ProductGallery() {
  ...
  const handleAddToCart = (p) => {
    ...
    const image =
      (Array.isArray(p.imagenes) && p.imagenes[0]) ? p.imagenes[0] : "/placeholder.svg";
  ...
  const filtered = cat ? products.filter((p) => p.categoria_slug === cat) : products;
        ...
        <div className="container">
          <div className="d-flex flex-column flex-md-row align-items-md-end justify-content-between gap-3 mb-4">
            ...
            <div className="d-flex gap-2 flex-wrap">
              ...
              <Link className="btn btn-outline-dark btn-sm" to="/tienda?cat=lentes-de-sol">
                Sol
              </Link>
              <Link className="btn btn-outline-dark btn-sm" to="/tienda?cat=recetados">
                Recetados
              </Link>
              <Link className="btn btn-outline-dark btn-sm" to="/tienda?cat=contacto">
                Contacto
              </Link>
            </div>
          </div>
                  ...
                  <div className="card h-100 product-card shadow-sm">
                    ...
                    <div className="card-body d-flex flex-column">
                      ...
                      <p className="mb-3 text-muted">
                        {p.precio_min ? formatCLP(p.precio_min) : "Precio por confirmar"}
                      </p>
                      ...
                      <div className="mt-auto d-flex gap-2">
                        <Link to={`/producto/${p.id}`} className="btn btn-dark w-100">
                          Ver detalle
                        </Link>
